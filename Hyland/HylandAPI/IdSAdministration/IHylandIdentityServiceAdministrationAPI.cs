...
public partial interface IHylandIdentityServiceAdministrationAPI : IHylandRestAPI
{
    ...
    [Get("/api/v{version}")]
    Task<IApiResponse> Api(string version);

    /// <summary>A way to test if the controller is responsive.</summary>
    [Post("/api/v{version}/isalive")]
    Task<IApiResponse> IsalivePost(string version);

    /// <summary>A way to test if the controller is responsive.</summary>
    [Put("/api/v{version}/isalive")]
    Task<IApiResponse> IsalivePut(string version);

    /// <summary>A way to test if the controller is responsive.</summary>
    [Delete("/api/v{version}/isalive")]
    Task<IApiResponse> IsaliveDelete(string version);

    /// <summary>A way to test if the controller is responsive.</summary>
    [Get("/api/v{version}/isalive")]
    Task<IApiResponse> IsaliveGet(string version);
    ...
    Task<ApiResponse<ICollection<string>>> AdminsGet(string tenantId, string version);
    ...
    Task<IApiResponse> AdminsPost(string tenantId, string version, [Body] AdministrativeUserRequestModel body);
    ...
    Task<IApiResponse> AdminsDelete(string tenantId, string username, string version);
    ...
    Task<ApiResponse<ICollection<ApiResource>>> ApiresourcesGet(string tenantId, string version);
    ...
    Task<ApiResponse<ApiResource>> ApiresourcesPost(string tenantId, string version, [Body] CreateModifyApiResource body);

    /// <summary>Get an ApiResource from the configurations</summary>
    [Get("/api/v{version}/tenants/{tenantId}/apiresources/{apiResourceId}")]
    Task<IApiResponse> ApiresourcesGet2(string tenantId, string apiResourceId, string version);

    /// <summary>Modify an ApiResource</summary>
    [Headers("Accept: text/plain, application/json, text/json", "Content-Type: application/json")]
    [Put("/api/v{version}/tenants/{tenantId}/apiresources/{apiResourceId}")]
    Task<ApiResponse<ApiResource>> ApiresourcesPut(string tenantId, string apiResourceId, string version, [Body] CreateModifyApiResource body);
    ...
    Task<IApiResponse> ApiresourcesDelete(string tenantId, string apiResourceId, string version);
    ...
    Task<ApiResponse<ICollection<IdNamePair>>> ClientsGet(string tenantId, string version);

    /// <summary>Create a new client in the configuration</summary>
    [Headers("Accept: text/plain, application/json, text/json", "Content-Type: application/json")]
    [Post("/api/v{version}/tenants/{tenantId}/clients")]
    Task<ApiResponse<Client>> ClientsPost(string tenantId, string version, [Body] CreateModifyClient body);

    /// <summary>Get a client from the configuration</summary>
    [Get("/api/v{version}/tenants/{tenantId}/clients/{clientId}")]
    Task<IApiResponse> ClientsGet2(string tenantId, string clientId, string version);

    /// <summary>Modify a client</summary>
    [Headers("Accept: text/plain, application/json, text/json", "Content-Type: application/json")]
    [Put("/api/v{version}/tenants/{tenantId}/clients/{clientId}")]
    Task<ApiResponse<Client>> ClientsPut(string tenantId, string clientId, string version, [Body] CreateModifyClient body);

    /// <summary>Delete a client from the configuration</summary>
    [Delete("/api/v{version}/tenants/{tenantId}/clients/{clientId}")]
    Task<IApiResponse> ClientsDelete(string tenantId, string clientId, string version);

    /// <summary>Creates a new client secret.</summary>
    [Headers("Content-Type: application/json")]
    [Post("/api/v{version}/tenants/{tenantId}/clients/secret")]
    Task<ApiResponse<ClientSecret>> Secret(string version, string tenantId, [Body] ClientSecret body);

    /// <summary>Process the usercode and authorize the device code authentication request</summary>
    [Headers("Content-Type: application/json")]
    [Post("/api/usercode")]
    Task<IApiResponse> Usercode([Body] string body);

    /// <summary>Initialize the operational database</summary>
    [Post("/Initialization/InitOpDbAsync")]
    Task<IApiResponse> InitOpDbAsync([Query, AliasAs("OperationalDbConnString")] string operationalDbConnString, [Query, AliasAs("ProviderType")] string providerType);
    ...
    Task<ApiResponse<ICollection<IdNamePair>>> ProvidersGet(string tenantId, string version);

    /// <summary>Add a provider to the configuration</summary>
    [Headers("Accept: text/plain, application/json, text/json", "Content-Type: application/json")]
    [Post("/api/v{version}/tenants/{tenantId}/providers")]
    Task<ApiResponse<object>> ProvidersPost(string tenantId, string version, [Body(BodySerializationMethod.Serialized)] object body);
    ...
    Task<ApiResponse<object>> ProvidersGet2(string tenantId, string providerId, string version);

    /// <summary>Modify a provider in the configuration</summary>
    [Headers("Accept: text/plain, application/json, text/json", "Content-Type: application/json")]
    [Put("/api/v{version}/tenants/{tenantId}/providers/{providerId}")]
    Task<ApiResponse<object>> ProvidersPut(string tenantId, string providerId, string version, [Body(BodySerializationMethod.Serialized)] object body);

    /// <summary>Delete a provider from the configuration</summary>
    [Delete("/api/v{version}/tenants/{tenantId}/providers/{providerId}")]
    Task<IApiResponse> ProvidersDelete(string tenantId, string providerId, string version);

    /// <summary>Return a list of acceptable attribute names</summary>
    [Get("/api/v{version}/userattributetypes")]
    Task<IApiResponse> Userattributetypes(string version);

    /// <summary>Post metadata to create new</summary>
    [Multipart]
    [Post("/api/saml2/external/metadata")]
    Task<IApiResponse> Metadata(StreamPart metadataFile);

    /// <summary>Get Metadata Location</summary>
    [Get("/api/saml2/external/metadata/location/{metadataLocation}")]
    Task<IApiResponse> Location([AliasAs("metadataLocation")] string metadataLocationPath, [Query, AliasAs("metadataLocation")] string metadataLocationQuery);

    /// <summary>Get a list of names of configured tenants</summary>
    [Get("/api/v{version}/tenants")]
    Task<ApiResponse<ICollection<IdNamePair>>> TenantsGet(string version);

    /// <summary>Add a tenant to the configuration</summary>
    [Headers("Accept: text/plain, application/json, text/json", "Content-Type: application/json")]
    [Post("/api/v{version}/tenants")]
    Task<ApiResponse<TenantModel>> TenantsPost(string version, [Body] CreateModifyTenant body);

    /// <summary>Get a tenant with the given Id</summary>
    [Get("/api/v{version}/tenants/{tenantId}")]
    Task<ApiResponse<TenantModel>> TenantsGet2(string tenantId, string version);

    /// <summary>Delete the tenant with the given Id from the configuration</summary>
    [Delete("/api/v{version}/tenants/{tenantId}")]
    Task<IApiResponse> TenantsDelete(string tenantId, string version);

    /// <summary>Modify the tenant object in the configuration</summary>
    [Headers("Accept: text/plain, application/json, text/json", "Content-Type: application/json")]
    [Put("/api/v{version}/tenants/{tenantId}")]
    Task<ApiResponse<TenantModel>> TenantsPut(string tenantId, string version, [Body] CreateModifyTenant body);

    /// <summary>Upload manually managed SCIM groups CSV file</summary>
    [Multipart]
    [Post("/api/v{version}/tenants/{tenantId}/mmgroups/import")]
    Task<IApiResponse> Import(string tenantId, string version, [AliasAs("ContentType")] string contentType, [AliasAs("ContentDisposition")] string contentDisposition, [AliasAs("Headers")] IDictionary<string, IEnumerable<string>> headers, [AliasAs("Length")] long? length, [AliasAs("Name")] string name, [AliasAs("FileName")] string fileName);

    /// <summary>Get all manually managed SCIM groups</summary>
    [Get("/api/v{version}/tenants/{tenantId}/mmgroups")]
    Task<IApiResponse> Mmgroups(string tenantId, string version);
}
